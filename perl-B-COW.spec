...
Source0  : https://cpan.metacpan.org/authors/id/A/AT/ATOOMIC/B-COW-0.002.tar.gz
...
%prep
%setup -q -n B-COW-0.002
cd %{_builddir}/B-COW-0.002
...
cp %{_builddir}/B-COW-0.002/LICENSE %{buildroot}/usr/share/package-licenses/perl-B-COW/dd4e29f997e82e723b165d30ec39001443a74f4d
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.30.1/x86_64-linux-thread-multi/B/COW.pm
/usr/lib/perl5/vendor_perl/5.30.1/x86_64-linux-thread-multi/auto/B/COW/COW.so

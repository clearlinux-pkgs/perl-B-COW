...
%prep
%setup -q -n B-COW-0.004
cd %{_builddir}/B-COW-0.004
...
cp %{_builddir}/B-COW-0.004/LICENSE %{buildroot}/usr/share/package-licenses/perl-B-COW/dd4e29f997e82e723b165d30ec39001443a74f4d
if test -f Makefile.PL; then
...
%files perl
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.34.0/x86_64-linux-thread-multi/B/COW.pm
/usr/lib/perl5/vendor_perl/5.34.0/x86_64-linux-thread-multi/auto/B/COW/COW.so
